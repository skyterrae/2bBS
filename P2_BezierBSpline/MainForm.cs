...
namespace P2_BezierBSpline
{
    ...
    {
        //hoofdForm die alles bevat en uitvoert 
        //in dit geval een form die je met curves laat spelen

        public static CurveBase Curve;
        ...
        #region VerversFunctie
        public override void Refresh()
        {
            //ververst en herberekend de curve als er iets veranderd is
        ...
        #region UpdateFunctions (Buttons)
        ...
        #region UpdateFunction  (ChoiseList)
