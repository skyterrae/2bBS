...
{
    class RecursiveBezier : CurveBase
    {
        //classe die zorgt voor het berekenen en tekenen van een recursief uitgerekende Bezier Curve

        PointF[] bezierPoints; // Array van de punten van de beziercurve. Wordt gevuld in de DoCasteljau-methode.

        public RecursiveBezier() : base(12, 6)
        {
            DoCasteljau();
        }
